...
var _mono_aot_CommandLine_get_method = Module['_mono_aot_CommandLine_get_method'] = (a0) => (_mono_aot_CommandLine_get_method = Module['_mono_aot_CommandLine_get_method'] = wasmExports['mono_aot_CommandLine_get_method'])(a0);
...
var _mono_aot_ScryfallApi_Client_get_method = Module['_mono_aot_ScryfallApi_Client_get_method'] = (a0) => (_mono_aot_ScryfallApi_Client_get_method = Module['_mono_aot_ScryfallApi_Client_get_method'] = wasmExports['mono_aot_ScryfallApi_Client_get_method'])(a0);
var _mono_aot_Serilog_get_method = Module['_mono_aot_Serilog_get_method'] = (a0) => (_mono_aot_Serilog_get_method = Module['_mono_aot_Serilog_get_method'] = wasmExports['mono_aot_Serilog_get_method'])(a0);
var _mono_aot_Serilog_Extensions_Logging_get_method = Module['_mono_aot_Serilog_Extensions_Logging_get_method'] = (a0) => (_mono_aot_Serilog_Extensions_Logging_get_method = Module['_mono_aot_Serilog_Extensions_Logging_get_method'] = wasmExports['mono_aot_Serilog_Extensions_Logging_get_method'])(a0);
var _mono_aot_Serilog_Settings_Configuration_get_method = Module['_mono_aot_Serilog_Settings_Configuration_get_method'] = (a0) => (_mono_aot_Serilog_Settings_Configuration_get_method = Module['_mono_aot_Serilog_Settings_Configuration_get_method'] = wasmExports['mono_aot_Serilog_Settings_Configuration_get_method'])(a0);
var _mono_aot_Serilog_Sinks_BrowserConsole_get_method = Module['_mono_aot_Serilog_Sinks_BrowserConsole_get_method'] = (a0) => (_mono_aot_Serilog_Sinks_BrowserConsole_get_method = Module['_mono_aot_Serilog_Sinks_BrowserConsole_get_method'] = wasmExports['mono_aot_Serilog_Sinks_BrowserConsole_get_method'])(a0);
var _mono_aot_Serilog_Sinks_Console_get_method = Module['_mono_aot_Serilog_Sinks_Console_get_method'] = (a0) => (_mono_aot_Serilog_Sinks_Console_get_method = Module['_mono_aot_Serilog_Sinks_Console_get_method'] = wasmExports['mono_aot_Serilog_Sinks_Console_get_method'])(a0);
var _mono_aot_Serilog_Sinks_Debug_get_method = Module['_mono_aot_Serilog_Sinks_Debug_get_method'] = (a0) => (_mono_aot_Serilog_Sinks_Debug_get_method = Module['_mono_aot_Serilog_Sinks_Debug_get_method'] = wasmExports['mono_aot_Serilog_Sinks_Debug_get_method'])(a0);
var _mono_aot_Serilog_Sinks_File_get_method = Module['_mono_aot_Serilog_Sinks_File_get_method'] = (a0) => (_mono_aot_Serilog_Sinks_File_get_method = Module['_mono_aot_Serilog_Sinks_File_get_method'] = wasmExports['mono_aot_Serilog_Sinks_File_get_method'])(a0);
var _mono_aot_MtgCsvHelper_get_method = Module['_mono_aot_MtgCsvHelper_get_method'] = (a0) => (_mono_aot_MtgCsvHelper_get_method = Module['_mono_aot_MtgCsvHelper_get_method'] = wasmExports['mono_aot_MtgCsvHelper_get_method'])(a0);
var _mono_aot_MtgCsvHelper_BlazorWebAssembly_get_method = Module['_mono_aot_MtgCsvHelper_BlazorWebAssembly_get_method'] = (a0) => (_mono_aot_MtgCsvHelper_BlazorWebAssembly_get_method = Module['_mono_aot_MtgCsvHelper_BlazorWebAssembly_get_method'] = wasmExports['mono_aot_MtgCsvHelper_BlazorWebAssembly_get_method'])(a0);
